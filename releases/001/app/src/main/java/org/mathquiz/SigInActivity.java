...
public class SigInActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (mAuth.getCurrentUser() != null) {
            startActivity(new Intent(SigInActivity.this, WebView_MathQuiz_Activity.class));
            finish();
        }
                        ...
                        .addOnCompleteListener(SigInActivity.this, new OnCompleteListener<AuthResult>() {
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                ...
                                if (task.isSuccessful()) {
                                    ...
                                    Intent intent = new Intent(SigInActivity.this, WebView_MathQuiz_Activity.class);
                                    startActivity(intent);
                                    finish();

                                } else {
                                    Log.d(TAG, "singInWithEmail:Fail");
                                    Toast.makeText(SigInActivity.this, getString(R.string.failed), Toast.LENGTH_LONG).show();
                                }
                            }
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(SigInActivity.this, "Aut Fail", Toast.LENGTH_SHORT).show();
                            updateUI(null);
                        }
